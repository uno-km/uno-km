...
window.AmevaPortfolioPDF = {
  ...
  loadHtml2Pdf: function() {
    return new Promise((resolve, reject) => {
      ...
      script.onerror = (e) => reject(new Error('html2pdf library load failed: ' + e));
  ...
  generatePortfolioPDF: async function(buttonElem) {
    ...
    try {
      ...
      // Build High-Quality Clean DOM for PDF Export
      ...
      container.innerHTML = `
        <style>
          ...
          .pdf-header { border-bottom: 2px solid #004499; padding-bottom: 12px; margin-bottom: 16px; }
          .pdf-title { font-size: 22px; font-weight: 800; color: #004499; margin: 0 0 6px 0; }
          .pdf-profile-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 6px; font-size: 11.5px; background: #f8fafc; padding: 10px 14px; border: 1px solid #e2e8f0; border-radius: 4px; margin-bottom: 16px; }
          .pdf-profile-item { margin: 2px 0; }
          .pdf-profile-item strong { color: #0f172a; }
          .pdf-h2 { font-size: 15px; font-weight: 700; color: #0f172a; border-bottom: 1px solid #cbd5e1; padding-bottom: 4px; margin: 18px 0 10px 0; }
          .pdf-h3 { font-size: 13px; font-weight: 700; color: #004499; margin: 14px 0 6px 0; }
          .pdf-table { width: 100%; border-collapse: collapse; margin: 10px 0; font-size: 10.5px; }
          .pdf-table th, .pdf-table td { border: 1px solid #cbd5e1; padding: 5px 7px; text-align: left; }
          .pdf-table th { background: #f1f5f9; color: #0f172a; font-weight: 700; }
          .pdf-card { background: #ffffff; border: 1px solid #e2e8f0; border-left: 3.5px solid #004499; padding: 10px 12px; margin-bottom: 12px; border-radius: 3px; }
          .pdf-card-title { font-size: 12.5px; font-weight: 700; color: #0f172a; margin: 0 0 4px 0; }
          .pdf-tag { display: inline-block; font-size: 9.5px; font-weight: 700; padding: 1px 5px; border-radius: 3px; background: #e0f2fe; color: #0369a1; margin-left: 4px; }
          .pdf-code { font-family: monospace; background: #f1f5f9; padding: 1px 4px; border-radius: 3px; font-size: 10.5px; color: #0f172a; }
          .pdf-footer { font-size: 9.5px; color: #94a3b8; text-align: right; margin-top: 15px; border-top: 1px solid #f1f5f9; padding-top: 4px; }
        </style>
        ...
        <div class="pdf-page">
          <div class="pdf-header">
            ...
            <div style="font-size:11px; color:#64748b;">AMEVA Open-Source Foundation (AOSF) 기술 생태계 &amp; 프로젝트 명세서 (기준일자: ${todayStr})</div>
          </div>
