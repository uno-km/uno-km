...
,
  ...
  class I18nManager {
    ...
    applyLanguage(lang) {
      ...
      const metaMap = {"playwright": {"brand": "Termux-Playwright", "title": "Termux-Playwright", "subtitles": {"en": "Production On-Device Browser Automation and Scraper Engine for Android Termux", "ko": "안드로이드 Termux를 위한 프로덕션급 온디바이스 브라우저 자동화 & 스크래핑 엔진", "ja": "Android Termux向けオンデバイスブラウザ自動化およびスクレイピングエンジン", "zh": "适用于 Android Termux 的端侧浏览器自动化与网页采集引擎", "hi": "Android Termux के लिए ऑन-डिवाइस ब्राउज़र ऑटोमेशन और स्क्रैपर इंजन", "ar": "محرك أتمتة المتصفح واستخراج البيانات على الأجهزة المحمولة لنظام Android Termux", "fr": "Moteur d'automatisation et de scraping de navigateur sur appareil pour Android Termux", "de": "On-Device-Browser-Automatisierungs- und Scraping-Engine für Android Termux", "es": "Motor de automatización y extracción de navegadores en el dispositivo para Android Termux", "ru": "Автоматизация браузера и сбор данных на устройствах Android Termux", "vi": "Công cụ tự động hóa và trích xuất trình duyệt trên thiết bị Android Termux", "pl": "Silnik automatyzacji i scrapowania przeglądarki na urządzeniach Android Termux", "la": "Machina automatica et extractio navigatoris in apparatu Android Termux"}}, "stt": {"brand": "Termux-STT", "title": "Termux-STT", "subtitles": {"en": "Production On-Device Speech-to-Text & 128d X-Vector Speaker Diarization for Android Termux", "ko": "안드로이드 Termux 전용 프로덕션급 온디바이스 음성인식 & 128차원 X-Vector 화자 분리 프레임워크", "ja": "Android Termux専用オンデバイス音声認識および128次元X-Vector話者分離フレームワーク", "zh": "适用于 Android Termux 的生产级端侧语音识别与 128 维 X-Vector 说话人日志分离框架", "hi": "Android Termux के लिए ऑन-डिवाइस स्पीच-टू-टेक्स्ट और 128d स्पीकर डायराइजेशन", "ar": "إطار عمل تحويل الكلام إلى نص والتعرف على المتحدث 128d لنظام Android Termux", "fr": "Framework de reconnaissance vocale et de diarisation des locuteurs 128d sur Android Termux", "de": "On-Device-Sprach-zu-Text- und 128d-X-Vector-Sprechertrennung für Android Termux", "es": "Framework de voz a texto y diarización de hablantes 128d en el dispositivo para Android Termux", "ru": "Распознавание речи и диаризация дикторов 128d на устройствах Android Termux", "vi": "Nhận dạng giọng nói và phân tách người nói 128d trên thiết bị Android Termux", "pl": "Rozpoznawanie mowy i diaryzacja mówców 128d na urządzeniach Android Termux", "la": "Recongnitio vocis et secretio locutorum 128d in apparatu Android Termux"}}, "tts": {"brand": "Termux-TTS", "title": "Termux-TTS", "subtitles": {"en": "Ultra-lightweight Zero-Dependency DSP Formant & Neural ONNX Speech Synthesis for Android Termux", "ko": "안드로이드 Termux를 위한 초경량 0MB 무의존성 DSP 포먼트 & 신경망 ONNX 음성 합성 프레임워크", "ja": "Android Termux向け超軽量0MB無依存DSPフォルマント＆ニューラルONNX音声合成フレームワーク", "zh": "适用于 Android Termux 的超轻量零依赖 DSP 共振峰与神经网络 ONNX 语音合成框架", "hi": "Android Termux के लिए अल्ट्रा-लाइटवेट ज़ीरो-डिपेंडेंसी डीएसपी फॉर्मैंट और न्यूरल ONNX स्पीच सिंथेसिस", "ar": "إطار عمل توليد الكلام فائق الخفة بدون تبعيات DSP Formant والشبكات العصبية ONNX لنظام Android Termux", "fr": "Framework de synthèse vocale ultra-léger sans dépendance DSP Formant et ONNX pour Android Termux", "de": "Ultraleichtes Zero-Dependency-DSP-Formant- und Neural-ONNX-Sprachsynthese-Framework für Android Termux", "es": "Framework de síntesis de voz ultra ligero sin dependencias DSP Formant y ONNX para Android Termux", "ru": "Сверхлегкий фреймворк синтеза речи без зависимостей DSP Formant и нейросетевого ONNX для Android Termux", "vi": "Khung tổng hợp giọng nói siêu nhẹ không phụ thuộc DSP Formant & mạng nơ-ron ONNX cho Android Termux", "pl": "Ultralekki framework syntezy mowy bez zależności DSP Formant i neuronowego ONNX dla Android Termux", "la": "Syntaxis levissima synthesis vocis DSP Formant et ONNX sine dependentiis pro Android Termux"}}, "diffusion": {"brand": "Termux-Diffusion", "title": "Termux-Diffusion", "subtitles": {"en": "Production On-Device AI Image Generation Framework for Android Termux & Samsung Galaxy", "ko": "안드로이드 Termux 및 삼성 갤럭시를 위한 온디바이스 AI 이미지 생성 프레임워크", "ja": "Android TermuxおよびSamsung Galaxy向けオンデバイスAI画像生成フレームワーク", "zh": "适用于 Android Termux 和三星 Galaxy 的生产级端侧 AI 图像生成框架", "hi": "Android Termux और Samsung Galaxy के लिए ऑन-डिवाइस AI इमेज जेनरेशन फ्रेमवर्क", "ar": "إطار عمل توليد الصور بالذكاء الاصطناعي على أجهزة Android Termux وSamsung Galaxy", "fr": "Framework de génération d'images IA sur appareil pour Android Termux et Samsung Galaxy", "de": "On-Device-KI-Bilderzeugungs-Framework für Android Termux und Samsung Galaxy", "es": "Framework de generación de imágenes IA en el dispositivo para Android Termux y Samsung Galaxy", "ru": "Генерация изображений с помощью ИИ на устройствах Android Termux и Samsung Galaxy", "vi": "Khung tạo hình ảnh AI trên thiết bị cho Android Termux & Samsung Galaxy", "pl": "Generowanie obrazów AI na urządzeniach Android Termux i Samsung Galaxy", "la": "Formatio imaginum per AI in apparatu Android Termux et Samsung Galaxy"}}, "train": {"brand": "Termux-Train", "title": "Termux-Train", "subtitles": {"en": "Ultra-lightweight On-Device Tensor & DAG Autograd Deep Learning Framework for Android ARM64 Termux", "ko": "안드로이드 ARM64 Termux를 위한 초경량 온디바이스 텐서 연산 & DAG 자동미분(Autograd) 딥러닝 프레임워크", "ja": "Android ARM64 Termux向け超軽量オンバイステンソル演算＆DAG自動微分深層学習フレームワーク", "zh": "适用于 Android ARM64 Termux 的超轻量端侧张量运算与有向无环图自动求导深度学习框架", "hi": "Android ARM64 Termux के लिए अल्ट्रा-लाइटवेट ऑन-डिवाइस टेंसर और DAG ऑटोग्रैड डीप लर्निंग फ्रेमवर्क", "ar": "إطار عمل للتعلم العميق وحساب المشتقات التلقائية خفيف الوزن لنظام Android ARM64 Termux", "fr": "Framework d'apprentissage profond et d'autodifférenciation DAG ultra-léger pour Android ARM64 Termux", "de": "Ultraleichtes On-Device-Tensor- und DAG-Autograd-Deep-Learning-Framework für Android ARM64 Termux", "es": "Framework de aprendizaje profundo y autograd de tensores ultraligero para Android ARM64 Termux", "ru": "Сверхлегкий фреймворк глубокого обучения и автографа тензоров для Android ARM64 Termux", "vi": "Khung học sâu Tensor & DAG Autograd siêu nhẹ trên thiết bị cho Android ARM64 Termux", "pl": "Ultralekki framework uczenia głębokiego i autogradu tensorów dla Android ARM64 Termux", "la": "Syntaxis levissima tensurae et autograd pro Android ARM64 Termux"}}, "forge": {"brand": "AMEVA-Forge", "title": "AMEVA-Forge", "subtitles": {"en": "Client-Compute Offloaded Architecture Browser-Native WebGPU Autograd Deep Learning Engine", "ko": "서버 비용 없는 브라우저 네이티브 WebGPU 딥러닝 & 자동미분(Autograd) 엔진", "ja": "サーバー費用ゼロのブラウザネイティブWebGPU深層学習＆自動微分エンジン", "zh": "零服务器成本的浏览器原生 WebGPU 自动求导与深度学习引擎", "hi": "ज़ीरो-सर्वर-लागत ब्राउज़र-मूल WebGPU ऑटोग्रैड डीप लर्निंग इंजन", "ar": "محرك التعلم العميق والمشتقات التلقائية WebGPU الأصلي في المتصفح بدون تكلفة خادم", "fr": "Moteur d'apprentissage profond et d'autodifférenciation WebGPU natif pour navigateur à coût serveur nul", "de": "Serverlose Browser-native WebGPU-Autograd-Deep-Learning-Engine", "es": "Motor de aprendizaje profundo y autograd WebGPU nativo del navegador sin costo de servidor", "ru": "Браузерный движок глубокого обучения WebGPU без затрат на сервер", "vi": "Công cụ học sâu WebGPU Autograd gốc trên trình duyệt không tốn chi phí máy chủ", "pl": "Natywny silnik uczenia głębokiego WebGPU i autogradu w przeglądarce bez kosztów serwera", "la": "Machina WebGPU nativa in navigatro sine pretio ministri"}}, "sentinel": {"brand": "AMEVA-Sentinel", "title": "AMEVA-Sentinel", "subtitles": {"en": "Privacy-first Security Observability and Deterministic Threat Scoring Layer for Web Applications", "ko": "웹 애플리케이션을 위한 프라이버시 우선 보안 관측성 및 결정론적 0~100 위협 스코어링 엔진", "ja": "Webアプリケーション向けプライバシー優先セキュリティ観測および決定論的脅威スコアリング層", "zh": "适用于 Web 应用的隐私优先安全可观测性与确定性威胁评分层", "hi": "वेब अनुप्रयोगों के लिए गोपनीयता-प्रथम सुरक्षा अवलोकन और खतरा स्कोरिंग परत", "ar": "طبقة مراقبة أمنية تعطي الأولوية للخصوصية وتسجيل التهديدات لتطبيقات الويب", "fr": "Couche d'observabilité de la sécurité et d'évaluation des menaces axée sur la confidentialité", "de": "Datenschutzorientierte Sicherheitsbeobachtbarkeit und Bedrohungsbewertung für Webanwendungen", "es": "Capa de observabilidad de seguridad y puntuación de amenazas que prioriza la privacidad", "ru": "Конфиденциальный уровень наблюдения за безопасностью и оценки угроз для веб-приложений", "vi": "Lớp quan sát bảo mật và chấm điểm mối đe dọa ưu tiên quyền riêng tư cho ứng dụng web", "pl": "Warstwa obserwowalności bezpieczeństwa i oceny zagrożeń zorientowana na prywatność", "la": "Stratum securitatis et computatio periculorum pro applicationibus interretialibus"}}, "mcp": {"brand": "AMEVA-MCP-Hub", "title": "AMEVA-MCP-Hub", "subtitles": {"en": "Polyglot Model Context Protocol Hub with In-Memory WASI WebAssembly Execution Engine", "ko": "인메모리 WASI WebAssembly 실행 엔진 기반 폴리글랏 모델 컨텍스트 프로토콜(MCP) 허브", "ja": "インメモリWASI WebAssembly実行エンジン搭載ポリグロットMCPハブ", "zh": "基于内存 WASI WebAssembly 执行引擎的多语言模型上下文协议 (MCP) 枢纽", "hi": "इन-मेमोरी WASI WebAssembly निष्पादन इंजन के साथ पॉलीग्लॉट मॉडल संदर्भ प्रोटोकॉल (MCP) हब", "ar": "مركز بروتوكول سياق النماذج المتعدد اللغات مع محرك تنفيذ WASI WebAssembly في الذاكرة", "fr": "Hub de protocole de contexte de modèle polyglotte avec moteur d'exécution WASI WebAssembly en mémoire", "de": "Polyglotter Model Context Protocol Hub mit In-Memory WASI WebAssembly-Ausführungs-Engine", "es": "Hub de protocolo de contexto de modelo políglota con motor de ejecución WASI WebAssembly en memoria", "ru": "Многоязычный хаб Model Context Protocol с движком исполнения WASI WebAssembly в памяти", "vi": "Trung tâm giao thức ngữ cảnh mô hình đa ngôn ngữ với công cụ thực thi WASI WebAssembly trong bộ nhớ", "pl": "Wielojęzyczny hub Model Context Protocol z silnikiem wykonawczym WASI WebAssembly w pamięci", "la": "Centrum protocolli contextus exemplarium polyglottum cum machina WASI WebAssembly in memoria"}}, "vulkan": {"brand": "AMEVA-Vulkan-Runtime", "title": "AMEVA-Vulkan-Runtime", "subtitles": {"en": "Universal Cross-Platform Vulkan Hardware Abstraction Layer & Compute Shader Pipeline", "ko": "범용 크로스 플랫폼 Vulkan 하드웨어 추상화 계층(HAL) & 고성능 컴퓨트 셰이더 파이프라인", "ja": "汎用クロスプラットフォームVulkanハードウェア抽象化層（HAL）＆コンピュートシェーダーパイプライン", "zh": "通用跨平台 Vulkan 硬件抽象层 (HAL) 与高性能计算着色器管线", "hi": "यूनिवर्सल क्रॉस-प्लेटफ़ॉर्म Vulkan हार्डवेयर एब्स्ट्रैक्शन लेयर (HAL) और कंप्यूट शेडर पाइपलाइन", "ar": "طبقة تجريد أجهزة Vulkan الشاملة عبر المنصات وخط أنابيب تظليل الحوسبة", "fr": "Couche d'abstraction matérielle Vulkan multiplateforme universelle et pipeline de shaders de calcul", "de": "Universelle plattformübergreifende Vulkan-Hardware-Abstraktionsschicht (HAL) & Compute-Shader-Pipeline", "es": "Capa de abstracción de hardware Vulkan multiplataforma universal y canalización de shaders de cálculo", "ru": "Универсальный кроссплатформенный уровень абстракции оборудования Vulkan и конвейер вычислительных шейдеров", "vi": "Lớp trừu tượng phần cứng Vulkan đa nền tảng phổ quát & đường ống đổ bóng tính toán", "pl": "Uniwersalna wieloplatformowa warstwa abstrakcji sprzętu Vulkan i potok shaderów obliczeniowych"}}, "aichain": {"brand": "Termux-AIChain", "title": "Termux-AIChain", "subtitles": {"en": "Zero-Dependency Deterministic AI Agent Workflow Orchestrator & State Machine for Android Termux", "ko": "안드로이드 Termux를 위한 제로 디펜던시 결정론적 AI 에이전트 워크플로우 오케스트레이터", "ja": "Android Termux向けゼロ依存・決定論的AIエージェントワークフローオーケストレーター", "zh": "适用于 Android Termux 的零依赖确定性 AI 智能体工作流编排与状态机", "hi": "Android Termux के लिए ज़ीरो-डिपेंडेंसी डिटरमिनिस्टिक AI एजेंट वर्कफ़्लो ऑर्केस्ट्रेटर", "ar": "منسق سير عمل وكلاء الذكاء الاصطناعي الحتمي بدون تبعيات لنظام Android Termux", "fr": "Orchestrateur de flux de travail d'agents IA déterministe sans dépendance pour Android Termux", "de": "Zero-Dependency deterministischer KI-Agenten-Workflow-Orchestrator für Android Termux", "es": "Orquestador de flujo de trabajo de agentes de IA determinista sin dependencias para Android Termux", "ru": "Детерминированный оркестратор рабочих процессов ИИ-агентов без зависимостей для Android Termux", "vi": "Trình điều phối quy trình làm việc của tác tử AI xác định không phụ thuộc cho Android Termux", "pl": "Deterministyczny orkiestrator przepływu pracy agentów AI bez zależności dla Android Termux"}}, "bitnet": {"brand": "Termux-BitNet", "title": "Termux-BitNet", "subtitles": {"en": "Ultra-Fast 1.58-Bit Quantized Large Language Model Inference Engine for Mobile ARM64", "ko": "모바일 ARM64 하드웨어를 위한 초고속 1.58비트 양자화 대규모 언어 모델(LLM) 추론 엔진", "ja": "モバイルARM64向け超高速1.58ビット量子化大規模言語モデル（LLM）推論エンジン", "zh": "适用于移动端 ARM64 架构的超高速 1.58 位量化大语言模型 (LLM) 推理引擎", "hi": "मोबाइल ARM64 के लिए अल्ट्रा-फास्ट 1.58-बिट क्वांटाइज्ड लार्ज लैंग्वेज मॉडल (LLM) इनफेरेंस इंजन", "ar": "محرك استدلال نماذج اللغة الكبيرة المكممة فائق السرعة 1.58 بت لأجهزة ARM64 المحمولة", "fr": "Moteur d'inférence de grand modèle de langage quantifié 1,58 bit ultra-rapide pour ARM64 mobile", "de": "Ultraschnelle 1,58-Bit quantisierte Large-Language-Model-Inferenz-Engine für mobiles ARM64", "es": "Motor de inferencia de modelos de lenguaje grandes cuantificados de 1,58 bits ultrarrápido para ARM64 móvil", "ru": "Сверхбыстрый движок вывода квантованных 1,58-битных языковых моделей для мобильных ARM64", "vi": "Công cụ suy luận mô hình ngôn ngữ lớn lượng tử hóa 1.58-bit siêu nhanh cho ARM64 di động", "pl": "Ultraszybki silnik wnioskowania skwantyzowanych modeli językowych 1,58-bitowych dla mobilnego ARM64"}}, "llamacpp": {"brand": "Termux-LlamaCpp", "title": "Termux-LlamaCpp", "subtitles": {"en": "Optimized GGUF LLM Execution Engine & OpenAI-Compatible Local Inference Server for Termux", "ko": "Termux 환경에 최적화된 GGUF LLM 실행 엔진 및 OpenAI 호환 온디바이스 로컬 추론 서버", "ja": "Termux環境に最適化されたGGUF LLM実行エンジン＆OpenAI互換オンデバイスローカル推論サーバー", "zh": "针对 Termux 优化的 GGUF LLM 执行引擎与兼容 OpenAI 的端侧本地推理服务器", "hi": "Termux के लिए अनुकूलित GGUF LLM निष्पादन इंजन और OpenAI-संगत स्थानीय इनफेरेंस सर्वर", "ar": "محرك تشغيل GGUF LLM المحسن وخادم استدلال محلي متوافق مع OpenAI لنظام Termux", "fr": "Moteur d'exécution GGUF LLM optimisé et serveur d'inférence local compatible OpenAI pour Termux", "de": "Optimierte GGUF LLM-Ausführungs-Engine & OpenAI-kompatibler lokaler Inferenzserver für Termux", "es": "Motor de ejecución GGUF LLM optimizado y servidor de inferencia local compatible con OpenAI para Termux", "ru": "Оптимизированный движок исполнения GGUF LLM и локальный сервер вывода, совместимый с OpenAI для Termux", "vi": "Công cụ thực thi GGUF LLM được tối ưu hóa & máy chủ suy luận cục bộ tương thích OpenAI cho Termux", "pl": "Zoptymalizowany silnik wykonawczy GGUF LLM i lokalny serwer wnioskowania zgodny z OpenAI dla Termux"}}, "vision": {"brand": "Termux-Vision", "title": "Termux-Vision", "subtitles": {"en": "On-Device Computer Vision, OCR & Visual Language Model (VLM) Framework for Mobile Edge", "ko": "모바일 에지 환경을 위한 온디바이스 컴퓨터 비전, OCR 및 시각 언어 모델(VLM) 프레임워크", "ja": "モバイルエッジ環境向けオンデバイスコンピュータビジョン、OCRおよび視覚言語モデル（VLM）フレームワーク", "zh": "适用于移动边缘端的端侧计算机视觉、OCR 与视觉语言模型 (VLM) 框架", "hi": "मोबाइल एज के लिए ऑन-डिवाइस कंप्यूटर विज़न, OCR और विज़ुअल लैंग्वेज मॉडल (VLM) फ्रेमवर्क", "ar": "إطار عمل الرؤية الحاسوبية والتعرف الضوئي على الحروف ونماذج اللغة البصرية على الأجهزة المحمولة", "fr": "Framework de vision par ordinateur, OCR et modèle de langage visuel (VLM) sur appareil pour Mobile Edge", "de": "On-Device Computer Vision, OCR & Visual Language Model (VLM) Framework für Mobile Edge", "es": "Framework de visión por computadora, OCR y modelo de lenguaje visual (VLM) en el dispositivo para Mobile Edge", "ru": "Фреймворк компьютерного зрения, OCR и визуально-языковых моделей (VLM) на устройствах для Mobile Edge", "vi": "Khung thị giác máy tính, OCR & mô hình ngôn ngữ hình ảnh (VLM) trên thiết bị cho Mobile Edge", "pl": "Framework wizji komputerowej, OCR i modeli wizualno-językowych (VLM) na urządzeniach dla Mobile Edge"}}, "infra-index": {"brand": "Infra-Index Platform", "title": "Infra-Index Platform", "subtitles": {"en": "High-Availability Distributed Infrastructure Telemetry & Global Node Health Monitoring Index", "ko": "고가용성 분산 인프라 텔레메트리 및 글로벌 노드 헬스 모니터링 인덱스 플랫폼", "ja": "高可用性分散インフラテレメトリ＆グローバルノードヘルスモニタリングインデックスプラットフォーム", "zh": "高可用分布式基础设施遥测与全球节点健康监控索引平台", "hi": "उच्च-उपलब्धता वितरित अवसंरचना टेलीमेट्री और वैश्विक नोड स्वास्थ्य निगरानी सूचकांक मंच", "ar": "قياس البنية التحتية الموزعة عالية التوفر ومنصة مؤشر مراقبة صحة العقد العالمية", "fr": "Télémétrie d'infrastructure distribuée à haute disponibilité et plateforme d'index de surveillance des nœuds", "de": "Hochverfügbare verteilte Infrastruktur-Telemetrie und globale Node-Health-Monitoring-Index-Plattform", "es": "Telemetría de infraestructura distribuida de alta disponibilidad y plataforma de índice de monitoreo de nodos", "ru": "Высокодоступная распределенная телеметрия инфраструктуры и платформа мониторинга здоровья глобальных узлов", "vi": "Đo từ xa cơ sở hạ tầng phân tán sẵn sàng cao & nền tảng chỉ số giám sát sức khỏe nút toàn cầu", "pl": "Wysoce dostępna rozproszona telemetria infrastruktury i globalna platforma monitorowania węzłów"}}, "foundation": {"brand": "AMEVA Open-Source Foundation", "title": "AMEVA 오픈소스 재단 (AOSF)", "subtitles": {"en": "Democratizing On-Device AI & Autonomous Systems Without Cloud Egress Dependency", "ko": "클라우드 종속성 없는 소버린 온디바이스 AI 및 자율 소프트웨어 생태계의 대중화", "ja": "クラウド依存のないソブリンオンデバイスAIおよび自律ソフトウェアエコシステムの民主化", "zh": "无云端依赖的 端侧自主 AI 与自主软件生态系统普惠化", "hi": "क्लाउड टैक्स के बिना ऑन-डिवाइस AI और स्वायत्त प्रणालियों का लोकतंत्रीकरण", "ar": "إتاحة الذكاء الاصطناعي على الأجهزة المحمولة والأنظمة المستقلة بدون ضرائب سحابية", "fr": "Démocratiser l'IA sur appareil et les systèmes autonomes sans taxe cloud", "de": "Demokratisierung von On-Device-KI und autonomen Systemen ohne Cloud-Steuer", "es": "Democratización de la IA en el dispositivo y los sistemas autónomos sin impuestos en la nube", "ru": "Демократизация локального ИИ и автономных систем без облачных подписок", "vi": "Phổ cập AI trên thiết bị & hệ thống tự trị mà không cần phí đám mây", "pl": "Demokratyzacja lokalnej sztucznej inteligencji i systemów autonomicznych bez opłat chmurowych", "la": "Democratizatio AI in apparatu et systematum autonomorum sine vectigali nubis"}}, "docs": {"brand": "AMEVA Ecosystem Architecture", "title": "AMEVA Ecosystem Architecture", "subtitles": {"en": "Comprehensive Technical Architecture & API Specifications for AMEVA Ecosystem", "ko": "AMEVA 온디바이스 생태계 종합 기술 아키텍처 및 통합 API 명세서", "ja": "AMEVAオンデバイスエコシステム総合技術アーキテクチャおよび統合API仕様書", "zh": "AMEVA 端侧生态系统综合技术架构与统一 API 规范", "hi": "AMEVA ऑन-डिवाइस इकोसिस्टम व्यापक तकनीकी वास्तुकला और एकीकृत API विनिर्देश", "ar": "الهندسة المعمارية التقنية الشاملة ومواصفات API الموحدة لمنظومة AMEVA", "fr": "Architecture technique complète et spécifications d'API unifiées pour l'écosystème AMEVA", "de": "Umfassende technische Architektur & einheitliche API-Spezifikationen für das AMEVA-Ökosystem", "es": "Arquitectura técnica integral y especificaciones de API unificadas para el ecosistema AMEVA", "ru": "Комплексная техническая архитектура и спецификации API для экосистемы AMEVA", "vi": "Kiến trúc kỹ thuật toàn diện & thông số kỹ thuật API thống nhất cho hệ sinh thái AMEVA", "pl": "Kompleksowa architektura techniczna i ujednolicone specyfikacje API dla ekosystemu AMEVA"}}};
        ...
        if (ctx !== 'foundation' && ctx !== 'root' && ctx !== 'docs') {
          ...
          if (key === 'home.subtitle' || key === 'home.heroSubtitle') {
            if (meta && meta.subtitles) {
              el.textContent = meta.subtitles[lang] || meta.subtitles['ko'] || meta.subtitles['en'] || el.textContent;
            }
            return;
          }
        }
