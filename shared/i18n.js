...
,
  ...
  class I18nManager {
    ...
    applyLanguage(lang) {
      ...
      const metaMap = {"playwright": {"brand": "Termux-Playwright", "title": "Termux-Playwright", "subtitles": {"en": "Production On-Device Browser Automation and Scraper Engine for Android Termux", "ko": "안드로이드 Termux를 위한 프로덕션급 온디바이스 브라우저 자동화 & 스크래핑 엔진"}}, "stt": {"brand": "Termux-STT", "title": "Termux-STT", "subtitles": {"en": "Production On-Device Speech-to-Text & 128d X-Vector Speaker Diarization for Android Termux", "ko": "안드로이드 Termux 전용 프로덕션급 온디바이스 음성인식 & 128차원 X-Vector 화자 분리 프레임워크"}}, "diffusion": {"brand": "Termux-Diffusion", "title": "Termux-Diffusion", "subtitles": {"en": "Production On-Device AI Image Generation Framework for Android Termux & Samsung Galaxy", "ko": "안드로이드 Termux 및 삼성 갤럭시를 위한 온디바이스 AI 이미지 생성 프레임워크"}}, "train": {"brand": "Termux-Train", "title": "Termux-Train", "subtitles": {"en": "Ultra-lightweight On-Device Tensor & DAG Autograd Deep Learning Framework for Android ARM64 Termux", "ko": "안드로이드 ARM64 Termux를 위한 초경량 온디바이스 텐서 연산 & DAG 자동미분(Autograd) 딥러닝 프레임워크"}}, "forge": {"brand": "AMEVA-Forge", "title": "AMEVA-Forge", "subtitles": {"en": "Client-Compute Offloaded Architecture Browser-Native WebGPU Autograd Deep Learning Engine", "ko": "서버 비용 없는 브라우저 네이티브 WebGPU 딥러닝 & 자동미분(Autograd) 엔진"}}, "sentinel": {"brand": "AMEVA-Sentinel", "title": "AMEVA-Sentinel", "subtitles": {"en": "Privacy-first Security Observability and Deterministic Threat Scoring Layer for Web Applications", "ko": "웹 애플리케이션을 위한 프라이버시 우선 보안 관측성 및 결정론적 0~100 위협 스코어링 엔진"}}, "mcp": {"brand": "AMEVA-MCP-Hub", "title": "AMEVA-MCP-Hub", "subtitles": {"en": "Polyglot Model Context Protocol Hub with In-Memory WASI WebAssembly execution engine", "ko": "인메모리 WASI WebAssembly 실행 엔진 기반 폴리글랏 모델 컨텍스트 프로토콜(MCP) 허브"}}, "vulkan": {"brand": "AMEVA-Vulkan-Runtime", "title": "AMEVA-Vulkan-Runtime", "subtitles": {"en": "Universal Cross-Platform Vulkan Hardware Abstraction Layer & Compute Shader Pipeline", "ko": "범용 크로스 플랫폼 Vulkan 하드웨어 추상화 계층(HAL) & 고성능 컴퓨트 셰이더 파이프라인"}}, "aichain": {"brand": "Termux-AIChain", "title": "Termux-AIChain", "subtitles": {"en": "Zero-Dependency Deterministic AI Agent Workflow Orchestrator & State Machine for Android Termux", "ko": "안드로이드 Termux를 위한 제로 디펜던시 결정론적 AI 에이전트 워크플로우 오케스트레이터"}}, "bitnet": {"brand": "Termux-BitNet", "title": "Termux-BitNet", "subtitles": {"en": "Ultra-Fast 1.58-Bit Quantized Large Language Model Inference Engine for Mobile ARM64", "ko": "모바일 ARM64 하드웨어를 위한 초고속 1.58비트 양자화 대규모 언어 모델(LLM) 추론 엔진"}}, "llamacpp": {"brand": "Termux-LlamaCpp", "title": "Termux-LlamaCpp", "subtitles": {"en": "Optimized GGUF LLM Execution Engine & OpenAI-Compatible Local Inference Server for Termux", "ko": "Termux 환경에 최적화된 GGUF LLM 실행 엔진 및 OpenAI 호환 온디바이스 로컬 추론 서버"}}, "vision": {"brand": "Termux-Vision", "title": "Termux-Vision", "subtitles": {"en": "On-Device Computer Vision, OCR & Visual Language Model (VLM) Framework for Mobile Edge", "ko": "모바일 에지 환경을 위한 온디바이스 컴퓨터 비전, OCR 및 시각 언어 모델(VLM) 프레임워크"}}, "tts": {"brand": "Termux-TTS", "title": "Termux-TTS", "subtitles": {"en": "Ultra-lightweight Zero-Dependency DSP Formant & Neural ONNX Speech Synthesis for Android Termux", "ko": "안드로이드 Termux를 위한 초경량 0MB 무의존성 DSP 포먼트 & 신경망 ONNX 음성 합성 프레임워크"}}, "infra-index": {"brand": "Infra-Index Platform", "title": "Infra-Index Platform", "subtitles": {"en": "High-Availability Distributed Infrastructure Telemetry & Global Node Health Monitoring Index", "ko": "고가용성 분산 인프라 텔레메트리 및 글로벌 노드 헬스 모니터링 인덱스 플랫폼"}}, "foundation": {"brand": "AMEVA Open-Source Foundation", "title": "AMEVA 오픈소스 재단 (AOSF)", "subtitles": {"en": "Democratizing On-Device AI & Autonomous Systems Without Cloud Egress Dependency", "ko": "클라우드 종속성 없는 소버린 온디바이스 AI 및 자율 소프트웨어 생태계의 대중화"}}, "docs": {"brand": "AMEVA Ecosystem Architecture", "title": "AMEVA Ecosystem Architecture", "subtitles": {"en": "Comprehensive Technical Architecture & API Specifications for AMEVA Ecosystem", "ko": "AMEVA 온디바이스 생태계 종합 기술 아키텍처 및 통합 API 명세서"}}};
