...
(function(global) {
  ...
  "Admin Dashboard": {
    ...
    "ja": "セキュリティダッシュボード",
    "zh": "安全控制台仪表板",
    "vi": "Bảng điều khiển bảo mật",
    "fr": "Tableau de Bord de Sécurité",
    "de": "Sicherheits-Dashboard",
    "es": "Panel de Control de Seguridad",
    "ru": "Панель мониторинга безопасности",
    "ar": "لوحة تحكم الأمان",
    "hi": "सुरक्षा डैशबोर्ड",
    "pl": "Pulpit bezpieczeństwa",
    "la": "Tabula Securitatis",
    "en": "Admin Dashboard"
  },
  "Security Dashboard": {
    "ko": "보안 대시보드",
  ...
  "Live Security Dashboard": {
    "ko": "실시간 보안 대시보드",
    "ja": "リアルタイムセキュリティダッシュボード",
    "zh": "实时安全仪表板",
    "vi": "Bảng điều khiển bảo mật thời gian thực",
    "fr": "Tableau de Bord de Sécurité en Temps Réel",
    "de": "Echtzeit-Sicherheits-Dashboard",
    "es": "Panel de Control de Seguridad en Tiempo Real",
    "ru": "Панель безопасности в реальном времени",
    "ar": "لوحة مراقبة الأمان المباشرة",
    "hi": "रीयल-टाइम सुरक्षा डैशबोर्ड",
    "pl": "Pulpit bezpieczeństwa w czasie rzeczywistym",
    "la": "Tabula Securitatis Viva",
    "en": "Live Security Dashboard"
  },
