...
if (window.i18nManager) {
  ...
  "en": {
    ...
    "home": {
      "title": "Termux-Playwright",
      "subtitle": "Non-Root Chromium Browser Automation & CDP Engine for Android Termux",
      ...
      "challengeText": "Official browser automation drivers fail on Android Termux due to missing X11/Wayland servers, glibc vs bionic ABI incompatibility, and sandboxing constraints.",
      "breakthroughTitle": "The Architectural Breakthrough",
      "breakthroughText": "Controls genuine Chromium processes via direct Chrome DevTools Protocol (CDP) WebSocket sessions on Android Bionic libc without root or graphical servers.",
      ...
      "features": {
        "0": {
          "title": "Direct CDP Control Channel",
          "desc": "Connects directly via Chrome DevTools Protocol without heavy WebDriver server binaries."
        },
        "1": {
          "title": "Non-Root Mobile Execution",
          "desc": "Fully operational inside standard Termux without root privileges or custom ROMs."
        },
        "2": {
          "title": "Full Python & JavaScript APIs",
          "desc": "Offers familiar Playwright-compatible async page navigation, selectors, and evaluation."
        }
      }
    }
  },
  "ko": {
    ...
    "home": {
      "title": "Termux-Playwright",
      "subtitle": "안드로이드 Termux 환경을 위한 비루팅 크로미움 브라우저 자동화 및 CDP 컨트롤러",
      "quickInstallTitle": "1줄 빠른 설치",
      "quickInstallDesc": "환경에 맞는 공식 패키지를 즉시 설치하세요:",
      "challengeTitle": "엔지니어링 도전 과제",
      "challengeText": "공식 브라우저 자동화 도구들은 glibc/bionic ABI 불일치와 X11 디스플레이 서버 부재로 인해 안드로이드 모바일 환경에서 구동되지 않습니다.",
      "breakthroughTitle": "아키텍처 혁신 및 해결책",
      "breakthroughText": "안드로이드 Bionic libc 상에서 구동되는 정품 크로미움 브라우저를 CDP 웹소켓 프로토콜로 직접 제어하여 모바일 상에서 무인 웹 크롤링 및 자동화 파이프라인을 구동합니다.",
      ...
      "features": {
        "0": {
          "title": "직접 CDP 웹소켓 제어 채널",
          "desc": "무거운 WebDriver 프록시 없이 크로미움 CDP 소켓에 직결되어 초고속 DOM 탐색 및 제어를 수행합니다."
        },
        "1": {
          "title": "루팅 없는 순정 단말기 실행",
          "desc": "단말기 루팅이나 커스텀 롬 플래싱 없이 일반 Termux 앱 환경에서 완벽히 구동됩니다."
        },
        "2": {
          "title": "완전한 Python 및 JavaScript API",
          "desc": "Playwright 표준과 친숙한 비동기 페이지 탐색, 셀렉터 클릭, 스크립트 실행 API를 제공합니다."
        }
      }
    }
  },
