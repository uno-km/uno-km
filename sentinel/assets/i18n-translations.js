...
if (window.i18nManager) {
  ...
  "en": {
    "common": {
      ...
      "releaseTag": "v1.0.0 (Stable Release)",
      "pypiBtn": "PyPI (pip)",
      "npmBtn": "npm (Node.js)",
      "githubBtn": "GitHub",
    ...
    "home": {
      ...
      "subtitle": "Privacy-First 0-Data Browser Observability & Deterministic 0~100 Threat Scoring SDK",
      ...
      "challengeText": "Conventional client security SDKs compromise user privacy by capturing sensitive keystrokes, form inputs, and behavioral telemetry back to central cloud collectors.",
      "breakthroughTitle": "The Architectural Breakthrough",
      "breakthroughText": "Delivers zero-data privacy protection with deterministic 0~100 threat scoring computed entirely on the client, verified across major browser engines with zero external telemetry leakage.",
      ...
      "features": {
        "0": {
          "title": "Zero-Data Privacy Boundary",
          "desc": "Never collects keystrokes, passwords, or PII. Evaluates only structural browser signals."
        },
        "1": {
          "title": "Deterministic 0~100 Scoring",
          "desc": "Deterministic weighted rule engine calculating objective risk levels without opaque black-box AI."
        },
        "2": {
          "title": "Cross-Engine Compatibility",
          "desc": "Tested across Chromium, Gecko, and WebKit with zero layout shift and sub-1ms evaluation."
        }
      }
    }
  },
  "ko": {
    ...
    "home": {
      "title": "AMEVA-Sentinel",
      "subtitle": "개인정보 침해 없는 0-Data 브라우저 관측 및 0~100점 확정적 위험도 채점 보안 SDK",
      "quickInstallTitle": "1줄 빠른 설치",
      "quickInstallDesc": "환경에 맞는 공식 패키지를 즉시 설치하세요:",
      "challengeTitle": "엔지니어링 도전 과제",
      "challengeText": "기존의 클라이언트 보안 SDK는 민감한 키 입력, 폼 데이터, 행동 데이터를 중앙 클라우드로 전송하여 사용자 개인정보 침해 위험을 초래합니다.",
      "breakthroughTitle": "아키텍처 혁신 및 해결책",
      "breakthroughText": "입력값 수집 없이 확정적 0~100점 위험도 채점 알고리즘을 클라이언트 내부에서 완전히 연산하며, 외부 유출 없이 브라우저 무결성을 검증합니다.",
      ...
      "features": {
        "0": {
          "title": "개인정보 0-Data 무결성 경계",
          "desc": "키보드 입력이나 개인정보를 일절 수집하지 않으며, 오직 브라우저 구조적 무결성 시그널만 분석합니다."
        },
        "1": {
          "title": "0~100점 확정적 위험도 채점",
          "desc": "블랙박스 인공지능 대신 검증 가능한 확정적 가중치 룰 엔진으로 객관적인 위험 점수를 산출합니다."
        },
        "2": {
          "title": "주요 브라우저 엔진 표준 호환",
          "desc": "크로미움, 게코, 웹킷 등 주요 브라우저 엔진에서 1ms 미만의 지연시간과 무간섭 실행을 보장합니다."
        }
      }
    }
  },
