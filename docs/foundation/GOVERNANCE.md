# AOSF Governance & Meritocracy Guidelines
AMEVA 재단 운영 규정 및 메리토크라시 헌장

Version: 1.0.0  
Standard: Meritocracy Governance Model
...
- 역할: 재단 전체의 거버넌스 감독, 지적재산권 및 상표권 보호, 인큐베이션 승인.
...
AOSF의 모든 결정은 표준 투표 규정을 따릅니다:

### 3.1 Vote Values (투표 값)
...
| TLP 플래그십 승격 (Graduation) | 인큐베이팅 -> TLP | 이사회 및 PMC 2/3 찬성 | 이사회 최종 인준 |
...
2. Zero Unverified Claims: 문서 린터 무오류 통과.
...
3. Step 3 (Nomination & Vote): 기존 PMC 멤버가 해당 기여자를 커미터 후보로 추천하고 투표를 진행합니다.
4. Step 4 (Welcome to AOSF): 승인 시 커밋 권한이 부여되며 공식 커미터 명부에 등재됩니다.

---

AMEVA Open-Source Foundation (AOSF)  
Open Governance. Transparent Engineering. Universal Accessibility.
