# AMEVA Open-Source Foundation (AOSF) Documentation Hub

Welcome to the official governance and documentation repository of the AMEVA Open-Source Foundation (AOSF).
...
- Foundation Portal: https://uno-km.github.io/uno-km/docs/foundation/
- Founder Profile & CV: [Eunho Kim (@uno-km)](../../README.md)
- Central Repository: https://github.com/uno-km/uno-km
