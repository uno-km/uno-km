...
AOSF는 개방형 실력주의(Meritocracy) 모델을 따릅니다.

1. Board of Directors (이사회): 재단의 전략적 방향성과 법적/재정적 책임을 총괄하며, 설립자(김은호 / Eunho Kim)가 초대 이사회 의장(Chair)을 역임합니다.
2. Project Management Committees (PMC): 각 프로젝트(TLP)의 기술적 로드맵과 릴리즈는 해당 프로젝트의 커미터들로 구성된 독립된 PMC가 자율적으로 결정합니다.
3. Consensus-Driven Decision Making: 모든 주요 안건은 공개 토론과 +1 / 0 / -1 투표제를 통해 투명하게 결정됩니다. (상세 내용은 GOVERNANCE.md 참조)

---

## Article V. Non-Discrimination & Code of Conduct (차별 금지 및 행동 강령)

AOSF는 인종, 성별, 국적, 종교, 장애, 성적 지향에 따른 일체의 차별을 배격하며, 모든 기여자에게 안전하고 포용적인 협업 환경을 제공합니다. 모든 참여자는 Contributor Covenant 기반의 행동 강령을 준수해야 합니다.
