...
if (window.i18nManager) {
  ...
  "en": {
    "common": {
      "brand": "Termux-BitNet",
      "releaseTag": "v1.0.0 (ARM64 NEON SIMD Accelerated Engine)",
      "pypiBtn": "PyPI (pip)",
      "npmBtn": "npm (Node.js)",
      "githubBtn": "GitHub",
    ...
    "home": {
      "title": "Termux-BitNet",
      "subtitle": "High-Performance 1.58-bit On-Device LLM Inference SIMD Engine for ARM64 & Android Termux",
      ...
      "challengeText": "Standard LLMs (FP16/INT8) cause severe memory bottleneck, excessive battery drain, and thermal throttling on mobile ARM64 devices.",
      "breakthroughTitle": "The Architectural Breakthrough",
      "breakthroughText": "Features ARM64 NEON DotProd SIMD kernels executing ternary weights {-1, 0, +1} with sub-15ms token latency on smartphone processors.",
  ...
  "ko": {
    ...
    "home": {
      "title": "Termux-BitNet",
      "subtitle": "안드로이드 Termux 및 ARM64 환경을 위한 초고성능 1.58비트 온디바이스 LLM 추론 SIMD 가속 엔진",
      "quickInstallTitle": "1줄 빠른 설치",
      "quickInstallDesc": "환경에 맞는 공식 패키지를 즉시 설치하세요:",
      "challengeTitle": "엔지니어링 도전 과제",
      "challengeText": "기존의 FP16/INT8 LLM은 모바일 ARM64 단말기에서 메모리 대역폭 병목과 심각한 배터리 소모 및 발열 스로틀링을 유발합니다.",
      "breakthroughTitle": "아키텍처 혁신 및 해결책",
      "breakthroughText": "3진수 가중치 {-1, 0, +1}를 ARM64 NEON DotProd SIMD 어셈블리 명령어로 직접 가속하여 스마트폰에서 15ms 미만의 토큰 생성 지연을 달성합니다.",
