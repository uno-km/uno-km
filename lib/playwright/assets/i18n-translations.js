...
if (window.i18nManager) {
  ...
  "en": {
    "common": {
      ...
      "releaseTag": "v1.0.0 (Bionic Chromium CDP Driver)",
      "pypiBtn": "PyPI (pip)",
      "npmBtn": "npm (Node.js)",
      "githubBtn": "GitHub",
    ...
    "home": {
      ...
      "subtitle": "Non-Root Real Chromium Automation & CDP Control Package for Android Termux",
      ...
      "challengeText": "Official Playwright binaries fail on Android Termux due to glibc dependencies, missing X11/Wayland display servers, and seccomp sandbox restrictions.",
      "breakthroughTitle": "The Architectural Breakthrough",
      "breakthroughText": "Directly interfaces with Termux Chromium via Chrome DevTools Protocol over isolated Unix domain sockets, enabling full scraping and automation with zero root requirements.",
  ...
  "ko": {
    ...
    "home": {
      "title": "Termux-Playwright",
      "subtitle": "안드로이드 Termux 환경에서 비루트로 정품 Chromium 브라우저 자동화를 구동하는 런타임 최적화 패키지",
      "quickInstallTitle": "1줄 빠른 설치",
      "quickInstallDesc": "환경에 맞는 공식 패키지를 즉시 설치하세요:",
      "challengeTitle": "엔지니어링 도전 과제",
      "challengeText": "공식 Playwright는 glibc 의존성과 디스플레이 서버 부재로 인해 안드로이드 Termux 유저스페이스에서 구동되지 않습니다.",
      "breakthroughTitle": "아키텍처 혁신 및 해결책",
      "breakthroughText": "격리된 유닉스 소켓 기반 Chrome DevTools Protocol(CDP) 직접 제어를 통해 루팅 없이 정품 크로미움 브라우저 제어 및 무인 웹 자동화를 완벽 지원합니다.",
