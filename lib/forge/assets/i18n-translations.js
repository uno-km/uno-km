...
if (window.i18nManager) {
  ...
  "en": {
    "common": {
      "brand": "AMEVA-Forge",
      "releaseTag": "v1.0.0 (WebGPU Stable)",
      "pypiBtn": "PyPI (pip)",
      "npmBtn": "npm (Node.js)",
      "githubBtn": "GitHub",
    ...
    "home": {
      "title": "AMEVA-Forge",
      "subtitle": "Browser-Native WebGPU Autograd Deep Learning Engine & Real-Time Interactive Studio",
      ...
      "challengeText": "Running deep learning and autograd workloads in client browsers typically suffers from sluggish JavaScript CPU emulation and heavy GPU VRAM memory leaks.",
      "breakthroughTitle": "The Architectural Breakthrough",
      "breakthroughText": "Executes PyTorch-compatible dynamic tensor computations via raw WebGPU WGSL compute shaders with deterministic weakref buffer pooling and zero memory leaks.",
      ...
      "features": {
        "0": {
          "title": "Pure WebGPU WGSL Compute Shaders",
          "desc": "Direct GPU hardware dispatching for forward and backward passes with zero JS overhead."
        },
        "1": {
          "title": "PyTorch Syntax Compatibility",
          "desc": "Supports familiar Tensor API, autograd DAG, backward(), and standard optimizers."
        },
        "2": {
          "title": "Leak-Free GPU Buffer Pooling",
          "desc": "Weakref lifecycle management preventing VRAM exhaustion during long training runs."
        }
      }
    }
  },
  "ko": {
    ...
    "home": {
      "title": "AMEVA-Forge",
      "subtitle": "WebGPU 컴퓨트 셰이더 기반 브라우저 네이티브 Autograd 딥러닝 텐서 엔진 및 실시간 스튜디오",
      "quickInstallTitle": "1줄 빠른 설치",
      "quickInstallDesc": "환경에 맞는 공식 패키지를 즉시 설치하세요:",
      "challengeTitle": "엔지니어링 도전 과제",
      "challengeText": "웹 브라우저 내부에서 딥러닝 및 역전파를 수행할 때 순수 JavaScript CPU 연산의 심각한 지연과 GPU 버퍼 고갈 문제가 발생합니다.",
      "breakthroughTitle": "아키텍처 혁신 및 해결책",
      "breakthroughText": "PyTorch 구문 호환 텐서 연산을 순수 WebGPU WGSL 컴퓨트 셰이더로 병렬 컴파일하고, weakref 기반 링 버퍼 풀링으로 VRAM 누수 없는 무결점 클라이언트 연산을 제공합니다.",
      ...
      "features": {
        "0": {
          "title": "순수 WebGPU WGSL 컴퓨트 셰이더",
          "desc": "순방향 및 역방향 연산을 브라우저 GPU 하드웨어에 직접 디스패치하여 초고속 병렬 처리를 수행합니다."
        },
        "1": {
          "title": "PyTorch 구문 완벽 호환",
          "desc": "PyTorch와 완벽히 호환되는 Tensor API, DAG 역전파, backward(), 옵티마이저를 지원합니다."
        },
        "2": {
          "title": "무누수 GPU 버퍼 풀링 및 수명 주기 관리",
          "desc": "Weakref 수명 주기 관리와 버퍼 풀링으로 장시간 모델 학습 시 GPU 메모리 고갈을 원천 차단합니다."
        }
      }
    }
  },
