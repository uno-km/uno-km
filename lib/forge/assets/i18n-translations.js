...
if (window.i18nManager) {
  ...
  "en": {
    "common": {
      "brand": "AMEVA-Forge",
      "releaseTag": "v1.0.0 (Browser-Native WebGPU Autograd Engine)",
      "pypiBtn": "PyPI (pip)",
      "npmBtn": "npm (Node.js)",
      "githubBtn": "GitHub",
    ...
    "home": {
      "title": "AMEVA-Forge",
      "subtitle": "Browser-Native WebGPU Deep Learning Tensor & Autograd Engine with PyTorch Syntax",
      ...
      "challengeText": "Server-side GPU inferencing costs explode with user scale, while user browser GPUs sit completely idle.",
      "breakthroughTitle": "The Architectural Breakthrough",
      "breakthroughText": "Compiles autograd computation graphs directly to WGSL WebGPU compute shaders, executing training and inference entirely on the client GPU with zero server egress.",
  ...
  "ko": {
    ...
    "home": {
      "title": "AMEVA-Forge",
      "subtitle": "PyTorch 구문 호환 및 클라이언트 연산 오프로딩의 브라우저 네이티브 WebGPU 딥러닝 텐서 엔진",
      "quickInstallTitle": "1줄 빠른 설치",
      "quickInstallDesc": "환경에 맞는 공식 패키지를 즉시 설치하세요:",
      "challengeTitle": "엔지니어링 도전 과제",
      "challengeText": "서버 측 GPU 연산 비용은 사용자 수에 비례하여 폭증하는 반면, 사용자 브라우저의 고성능 GPU는 유휴 상태로 방치됩니다.",
      "breakthroughTitle": "아키텍처 혁신 및 해결책",
      "breakthroughText": "자동미분 연산 그래프를 WGSL WebGPU 셰이더로 직접 컴파일하여 서버 비용 0원으로 클라이언트 브라우저에서 딥러닝 연산을 직접 가속합니다.",
