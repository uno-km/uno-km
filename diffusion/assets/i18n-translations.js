...
if (window.i18nManager) {
  ...
  "en": {
    "common": {
      ...
      "releaseTag": "v1.1.1 (Production Stable)",
      "pypiBtn": "PyPI (pip)",
      "npmBtn": "npm (Node.js)",
      "githubBtn": "GitHub",
    ...
    "home": {
      ...
      "subtitle": "Native On-Device Stable Diffusion Runtime for Android Termux & ARM64",
      ...
      "challengeText": "Generating AI images on mobile devices typically requires cloud API dependencies or heavy virtualized container layers (PRoot) that quickly exceed RAM limits.",
      "breakthroughTitle": "The Architectural Breakthrough",
      "breakthroughText": "Executes quantized Stable Diffusion models directly on Android Bionic libc with NEON SIMD vector acceleration and direct Samsung Gallery indexing.",
      ...
      "features": {
        "0": {
          "title": "Zero-PRoot Native ARM64 Bionic",
          "desc": "Executes directly without root permissions, virtual machines, or PRoot Linux overhead."
        },
        "1": {
          "title": "Dual Python & Node.js Engine",
          "desc": "Provides comprehensive CLI and programmatic APIs across both Python and JavaScript."
        },
        "2": {
          "title": "Samsung Gallery Auto-Indexing",
          "desc": "Automatically broadcasts Android MEDIA_SCANNER intents to register generated art in Gallery."
        }
      }
    }
  },
  "ko": {
    ...
    "home": {
      "title": "Termux-Diffusion",
      "subtitle": "안드로이드 Termux 및 ARM64 환경을 위한 네이티브 온디바이스 Stable Diffusion 런타임",
      "quickInstallTitle": "1줄 빠른 설치",
      "quickInstallDesc": "환경에 맞는 공식 패키지를 즉시 설치하세요:",
      "challengeTitle": "엔지니어링 도전 과제",
      "challengeText": "모바일 환경에서 AI 이미지 생성은 클라우드 API 의존성을 요구하거나 무거운 가상화(PRoot) 계층으로 인해 RAM 한계를 초과하여 강제 종료됩니다.",
      "breakthroughTitle": "아키텍처 혁신 및 해결책",
      "breakthroughText": "안드로이드 순정 Bionic libc 상에서 NEON SIMD 벡터 가속을 결합하여 가상화 오버헤드 없이 고화질 이미지를 생성하고 삼성 갤러리에 즉시 자동 동기화합니다.",
      ...
      "features": {
        "0": {
          "title": "비루트 순정 Bionic 네이티브 실행",
          "desc": "루팅 권한이나 가상 머신 없이 안드로이드 네이티브 Bionic libc에서 직접 고속 실행됩니다."
        },
        "1": {
          "title": "Python 및 Node.js 듀얼 엔진",
          "desc": "CLI 명령어 및 Python, Node.js 양대 환경을 모두 지원하는 완전한 SDK를 제공합니다."
        },
        "2": {
          "title": "삼성 갤러리 미디어 자동 인덱싱",
          "desc": "이미지 생성 즉시 안드로이드 미디어 스캐너 인텐트를 전송하여 갤러리 앱에 실시간 반영합니다."
        }
      }
    }
  },
